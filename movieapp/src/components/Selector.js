...
export function Selector() {
  ...
  options = [
    { value: 1, label: "Popular" }, { value: 16, label: "Animation" }, { value: 35, label: "Comedy" }, { value: 80, label: "Crime" }, { value: 99, label: "Docmentary" },  { value: 18, label: "Drama" }, { value: 10751, label: "Family" }, { value: 36, label: "History" }, { value: 9648, label: "Mystery" }, { value: 10749, label: "Romance" },   { value: 37, label: "Western" },
  ]
}
